...
THEORY ListInvariantX IS
  ...
  Expanded_List_Invariant(Implementation(traffic_light_asm_z80))==(mpstack : WORD16 --> WORD16 & mprgs8 : id_register8 --> WORD8 & mpmem : WORD16 --> WORD8 & mppc : WORD16 & mpsp : WORD16 & mpix : WORD16 & mpiy : WORD16);
...
THEORY ListIncludedOperationsX IS
  List_Included_Operations(Implementation(traffic_light_asm_z80),Machine(Z80))==(CALL,RETURN,LD_r_r_,LD_r_n_,LD_r_HL,LD_HL_r,BIT_b_HL,JP_z_e,SET_b_HL,RES_b_HL,GOTO)
END
&
...
THEORY ListVisibleStaticX IS
  ...
  List_Constants(Implementation(traffic_light_asm_z80),Machine(ALU))==(add,substract,and,ior,xor,bitclear,bitset,bitget,complement,swap,rotateleft,rotateright);
