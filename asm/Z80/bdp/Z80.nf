...
THEORY ListOperationsX IS
  Internal_List_Operations(Machine(Z80))==(LD_r_r_,LD_r_n_,LD_r_HL,LD_r_9IX_d0,LD_r_9IY_d0,LD_9HL0_n,LD_HL_r,BIT_b_HL,JP_z_e,SET_b_HL,RES_b_HL,GOTO,CALL,RETURN);
  List_Operations(Machine(Z80))==(LD_r_r_,LD_r_n_,LD_r_HL,LD_r_9IX_d0,LD_r_9IY_d0,LD_9HL0_n,LD_HL_r,BIT_b_HL,JP_z_e,SET_b_HL,RES_b_HL,GOTO,CALL,RETURN)
END
&
THEORY ListInputX IS
  ...
  List_Input(Machine(Z80),LD_9HL0_n)==(nn);
...
THEORY ListHeaderX IS
  ...
  List_Header(Machine(Z80),LD_9HL0_n)==(LD_9HL0_n(nn));
...
THEORY ListPreconditionX IS
  ...
  List_Precondition(Machine(Z80),LD_r_9IY_d0)==(rr : id_register8 & dd : WORD8);
  List_Precondition(Machine(Z80),LD_9HL0_n)==(nn : WORD8);
...
THEORY ListSubstitutionX IS
  ...
  Expanded_List_Substitution(Machine(Z80),LD_9HL0_n)==(nn : WORD8 | @address.(address : WORD16 & address = WORD8_TO_WORD16(rgs8(h),rgs8(l)) ==> mem,pc:=mem<+{address|->nn},INSTRUCTION_NEXT(pc)));
  Expanded_List_Substitution(Machine(Z80),LD_r_9IY_d0)==(rr : id_register8 & dd : WORD8 | @(address,iszero,overflow).(address : WORD16 & iszero : BOOL & overflow : BOOL & address,iszero,overflow = add16(iy,WORD8_TO_WORD16(0,dd)) ==> rgs8,pc:=rgs8<+{rr|->mem(address)},INSTRUCTION_NEXT(pc)));
  ...
  List_Substitution(Machine(Z80),LD_r_9IY_d0)==(ANY address,iszero,overflow WHERE address : WORD16 & iszero : BOOL & overflow : BOOL & address,iszero,overflow = add16(iy,WORD8_TO_WORD16(0,dd)) THEN rgs8(rr):=mem(address) || pc:=INSTRUCTION_NEXT(pc) END);
  List_Substitution(Machine(Z80),LD_9HL0_n)==(ANY address WHERE address : WORD16 & address = WORD8_TO_WORD16(rgs8(h),rgs8(l)) THEN mem(address):=nn || pc:=INSTRUCTION_NEXT(pc) END);
