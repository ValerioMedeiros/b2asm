...
THEORY ListConstantsX IS
  List_Valuable_Constants(Machine(BIT_VECTOR_DEFINITION))==(BIT_VECTOR,bv_catenate,bv_sub,bv_zero,bv_one,bv_size,bv_not,bv_and,bv_or,bv_xor,bv_get,bv_set,bv_clear,bv_put,phys_bv_index);
  Inherited_List_Constants(Machine(BIT_VECTOR_DEFINITION))==(?);
  List_Constants(Machine(BIT_VECTOR_DEFINITION))==(BIT_VECTOR,bv_catenate,bv_sub,bv_zero,bv_one,bv_size,bv_not,bv_and,bv_or,bv_xor,bv_get,bv_set,bv_clear,bv_put,phys_bv_index)
END
&
THEORY ListSetsX IS
