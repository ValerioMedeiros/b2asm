...
THEORY ListConstantsX IS
  ...
  List_Constants(Machine(TYPES))==(WORD,WORD_LEN,WORD_POSITION,NB_WORD,COMPLEMENT_2,INSTRUCTION,NB_INSTRUCTIONS,INSTRUCTION_MAX,INSTRUCTION_IJUMP,INSTRUCTION_NEXT,BV_TO_WORD,WORD_TO_BV,WORD_TO_COMP2,COMP2_TO_WORD,OVERFLOW_ADD,OVERFLOW_SUB,MEM_ADDR,RAM_ADDR,SFR_ADDR,MAX_ADDR,BIT_ADDRESS)
END
&
THEORY ListSetsX IS
