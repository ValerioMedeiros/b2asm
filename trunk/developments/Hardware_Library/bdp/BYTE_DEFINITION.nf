...
THEORY ListConstantsX IS
  List_Valuable_Constants(Machine(BYTE_DEFINITION))==(BYTE,BYTE_INDEX,BYTE_ZERO,REAL_BYTE_INDEX,byte_bit_get,get_upper_digit,get_lower_digit);
  Inherited_List_Constants(Machine(BYTE_DEFINITION))==(?);
  List_Constants(Machine(BYTE_DEFINITION))==(BYTE,BYTE_INDEX,BYTE_ZERO,REAL_BYTE_INDEX,byte_bit_get,get_upper_digit,get_lower_digit)
END
&
THEORY ListSetsX IS
