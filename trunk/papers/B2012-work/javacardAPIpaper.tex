...
variable that controls balance and a operation to add credits to the
balance. This is simple example provides enough evidence of the
...
[[[ PARA SIMONE -> Por favor, coloque os exemplos sob a forma de listing. Fica mais fácil de editar, controlar o tamanho e conteúdo e fica mais legível.
Quanto ao código javacard, basta o da operação addcredit. Aliás, o nome não está batendo. Não verifiquei o resto. Por favor verifique. ]]]
