...
Uma discussão a ser feita quanto a essa parte:

ainda não publicamos nada em revista relacionado ao BSmart - como já
tem muitas publicações pontuais, acho que uma possibilidade de
publicar em revista seria fazer algo muito completo: método,
ferramenta, host e cartão, kit, estudo(s) de caso, verificações de
correção... A dúvida então é: será que falar aqui do passport vai
prejudicar uma publicação mais importante? Vamos tentar essa
publicação mais importante ou não? Eu acho que podemos usar o passport aqui só para mostrar um exemplo concreto de uso da especificação da API, sem focar na parte da avaliação do BSmart. Concordam?
