...
For example in official manual of the microcontroller Z80 \cite{Z80_manual}, if the users \marginpar{VM: Adicionei um exemplo real e uma referência  que cita vários problemas identificados no Manual do Z80.} 
want to know the action of an instruction and its effects on the flag register then he needs
to read an informal textual description, that  some times can be placed in different pages. 
