...
not generate proof obligations of the type of functions defined in the
 $PROPERTIES$ clause of a machine. For example, the definition $inc \in
...
%\marginpar{Não seria interessante ter colocado
...
bijective and to be equal to the reverse of the dual conversion
