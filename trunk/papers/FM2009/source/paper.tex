...
%  Porque modelar os microcontroladores.
...
%  Contextualizacao com grande desafio da verificao formal em nivel de assemblagem[citar grande challenge][citar proposta do ALEMAO do ProB] 
...
Every logic functions defined in the $\mathit{BYTE}$ and $\mathit{BV16}$ module are included in the $\mathit{ALU}$
module. Then, it was not necessary rewrite these functions.

\subsubsection{Modelling the instructions} 
[[Show and  LD n A]]




\subsection{Modelling the Interrupts}
...
by the follow B operation. This instruction is from I/O group and update the flag registers.
...
%  
%  
%  Algumas informações do manual do Z80 fornecido pela Zilog são imprecisas,
...
%  dúvidas foram sanadas com o uso do simulador(Z80 IDE Simulator). 
%  
...
\bibitem{Medeiros}
 Val\'{e}rio Medeiros Jr., Stephenson Galv\~{a}o, David D\'{e}harbe. D\'{e}harbe, D; Galv\~{a}o, S; ET AL. Modelagem
 de Microcontroladores em B. In: ERMAC, Natal, 2008. SBMAC.
