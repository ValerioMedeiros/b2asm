...
aproximadamente um mês. Isto foi custoso, porque foi necessário elaborar, retificar e provar várias lemmas
dos projetos de base, Hardware and Types Library. Entretanto, com os projetos básicos mais maduros,
torna-se bem mais rápida a modelagem e verificação de um novo microprocessador\footnote{Actualy, the
microprocessors M8051 and PIC16F432 are under construction}.
