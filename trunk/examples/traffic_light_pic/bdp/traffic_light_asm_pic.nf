...
&
THEORY ListSeesX IS
  List_Sees(Implementation(traffic_light_asm_pic))==(definitions,data_refinement,TYPES,ALU)
END
&
...
THEORY ListAssertionsX IS
  ...
  List_Assertions(Implementation(traffic_light_asm_pic))==(INSTRUCTION_NEXT(0) = 1 & INSTRUCTION_NEXT(1) = 2 & INSTRUCTION_NEXT(2) = 3 & INSTRUCTION_NEXT(3) = 4 & INSTRUCTION_NEXT(4) = 5 & INSTRUCTION_NEXT(5) = 6 & INSTRUCTION_NEXT(6) = 7 & INSTRUCTION_NEXT(7) = 8 & INSTRUCTION_NEXT(8) = 9 & INSTRUCTION_NEXT(9) = 10)
END
&
...
THEORY ListInstanciatedParametersX IS
  ...
  List_Instanciated_Parameters(Implementation(traffic_light_asm_pic),Machine(ALU))==(?)
END
&
...
THEORY ListSubstitutionX IS
  Expanded_List_Substitution(Implementation(traffic_light_asm_pic),advance)==(btrue | (0 : INSTRUCTION | mstack,msp,mpc:=mstack<+{msp|->INSTRUCTION_NEXT(mpc)},msp+1,0);WHILE mpc<10 DO not(mpc = 9) & not(mpc = 8) & not(mpc = 7) & not(mpc = 6) & not(mpc = 5) & not(mpc = 4) & not(mpc = 3) & not(mpc = 2) & not(mpc = 1) & mpc = 0 ==> (0 : REGISTER & 1 : WORD_POSITION | bitget(mmem(0),1) = 0 ==> mpc:=INSTRUCTION_NEXT(INSTRUCTION_NEXT(mpc)) [] not(bitget(mmem(0),1) = 0) ==> mpc:=INSTRUCTION_NEXT(mpc)) [] not(mpc = 0) & not(mpc = 9) & not(mpc = 8) & not(mpc = 7) & not(mpc = 6) & not(mpc = 5) & not(mpc = 4) & not(mpc = 3) & not(mpc = 2) & mpc = 1 ==> (8 : INSTRUCTION | mpc:=8) [] not(mpc = 0) & not(mpc = 1) & not(mpc = 9) & not(mpc = 8) & not(mpc = 7) & not(mpc = 6) & not(mpc = 5) & not(mpc = 4) & not(mpc = 3) & mpc = 2 ==> (0 : REGISTER & 0 : WORD_POSITION | bitget(mmem(0),0) = 0 ==> mpc:=INSTRUCTION_NEXT(INSTRUCTION_NEXT(mpc)) [] not(bitget(mmem(0),0) = 0) ==> mpc:=INSTRUCTION_NEXT(mpc)) [] not(mpc = 0) & not(mpc = 1) & not(mpc = 2) & not(mpc = 9) & not(mpc = 8) & not(mpc = 7) & not(mpc = 6) & not(mpc = 5) & not(mpc = 4) & mpc = 3 ==> (6 : INSTRUCTION | mpc:=6) [] not(mpc = 0) & not(mpc = 1) & not(mpc = 2) & not(mpc = 3) & not(mpc = 9) & not(mpc = 8) & not(mpc = 7) & not(mpc = 6) & not(mpc = 5) & mpc = 4 ==> (1 : WORD | mw,mpc:=1,INSTRUCTION_NEXT(mpc)) [] not(mpc = 0) & not(mpc = 1) & not(mpc = 2) & not(mpc = 3) & not(mpc = 4) & not(mpc = 9) & not(mpc = 8) & not(mpc = 7) & not(mpc = 6) & mpc = 5 ==> (9 : INSTRUCTION | mpc:=9) [] not(mpc = 0) & not(mpc = 1) & not(mpc = 2) & not(mpc = 3) & not(mpc = 4) & not(mpc = 5) & not(mpc = 9) & not(mpc = 8) & not(mpc = 7) & mpc = 6 ==> (2 : WORD | mw,mpc:=2,INSTRUCTION_NEXT(mpc)) [] not(mpc = 0) & not(mpc = 1) & not(mpc = 2) & not(mpc = 3) & not(mpc = 4) & not(mpc = 5) & not(mpc = 6) & not(mpc = 9) & not(mpc = 8) & mpc = 7 ==> (9 : INSTRUCTION | mpc:=9) [] not(mpc = 0) & not(mpc = 1) & not(mpc = 2) & not(mpc = 3) & not(mpc = 4) & not(mpc = 5) & not(mpc = 6) & not(mpc = 7) & not(mpc = 9) & mpc = 8 ==> (0 : WORD | mw,mpc:=0,INSTRUCTION_NEXT(mpc)) [] not(mpc = 0) & not(mpc = 1) & not(mpc = 2) & not(mpc = 3) & not(mpc = 4) & not(mpc = 5) & not(mpc = 6) & not(mpc = 7) & not(mpc = 8) & mpc = 9 ==> (0 : REGISTER | mmem,mpc:=mmem<+{0|->mw},INSTRUCTION_NEXT(mpc)) [] not(mpc = 0) & not(mpc = 1) & not(mpc = 2) & not(mpc = 3) & not(mpc = 4) & not(mpc = 5) & not(mpc = 6) & not(mpc = 7) & not(mpc = 8) & not(mpc = 9) ==> skip INVARIANT 0<=mpc & mpc<=10 & msp>0 & mmem(0) : 0..2 & (mpc = 0 => mmem(0) : 0..2 & mmem(0) = counter) & (mpc = 1 => mmem(0) = 2 & counter = 2) & (mpc = 2 => mmem(0)/=2 & mmem(0) = counter) & (mpc = 3 => mmem(0) = 1 & counter = 1) & (mpc = 4 => mmem(0) = 0 & mmem(0) = counter) & (mpc = 5 => mmem(0) = 0 & mmem(0) = counter & mw = 1) & (mpc = 6 => mmem(0) = 1 & mmem(0) = counter) & (mpc = 7 => mmem(0) = 1 & mmem(0) = counter & mw = 2) & (mpc = 8 => mmem(0) = 2 & mmem(0) = counter) & (mpc = 9 => mmem(0) : 0..2 & mmem(0) = counter & mw = color_step(counter)) & (mpc = 10 => mmem(0) : 0..2 & mmem(0) = color_step(counter)) VARIANT 10-mpc END;(msp>0 | mpc,mstack,msp:=mstack(msp-1),{msp-1}<<|mstack,msp-1));
  List_Substitution(Implementation(traffic_light_asm_pic),advance)==((m.CALL)(0);WHILE m.pc<10 DO BEGIN CASE m.pc OF EITHER 0 THEN (m.BTFSC)(0,1) OR 1 THEN (m.GOTO)(8) OR 2 THEN (m.BTFSC)(0,0) OR 3 THEN (m.GOTO)(6) OR 4 THEN (m.MOVLW)(1) OR 5 THEN (m.GOTO)(9) OR 6 THEN (m.MOVLW)(2) OR 7 THEN (m.GOTO)(9) OR 8 THEN (m.MOVLW)(0) OR 9 THEN (m.MOVWF)(0) END END END INVARIANT 0<=m.pc & m.pc<=10 & m.sp>0 & (m.mem)(0) : 0..2 & (m.pc = 0 => (m.mem)(0) : 0..2 & (m.mem)(0) = counter) & (m.pc = 1 => (m.mem)(0) = 2 & counter = 2) & (m.pc = 2 => (m.mem)(0)/=2 & (m.mem)(0) = counter) & (m.pc = 3 => (m.mem)(0) = 1 & counter = 1) & (m.pc = 4 => (m.mem)(0) = 0 & (m.mem)(0) = counter) & (m.pc = 5 => (m.mem)(0) = 0 & (m.mem)(0) = counter & m.w = 1) & (m.pc = 6 => (m.mem)(0) = 1 & (m.mem)(0) = counter) & (m.pc = 7 => (m.mem)(0) = 1 & (m.mem)(0) = counter & m.w = 2) & (m.pc = 8 => (m.mem)(0) = 2 & (m.mem)(0) = counter) & (m.pc = 9 => (m.mem)(0) : 0..2 & (m.mem)(0) = counter & m.w = color_step(counter)) & (m.pc = 10 => (m.mem)(0) : 0..2 & (m.mem)(0) = color_step(counter)) VARIANT 10-m.pc END;m.RETURN)
END
&
...
THEORY ListSeenInfoX IS
  Seen_Internal_List_Operations(Implementation(traffic_light_asm_pic),Machine(ALU))==(?);
  ...
  Seen_Context_List_Assertions(Implementation(traffic_light_asm_pic))==(!c.(c : COLOR => c = green or c = yellow or c = red) & BIT_XOR(1,1) = 0 & BIT_XOR(1,0) = 1 & BIT_XOR(0,1) = 1 & BIT_XOR(0,0) = 0 & BIT_IOR(1,1) = 1 & BIT_IOR(1,0) = 0 & BIT_IOR(0,1) = 0 & BIT_IOR(0,0) = 0 & BIT_AND(1,1) = 1 & BIT_AND(1,0) = 0 & BIT_AND(0,1) = 0 & BIT_AND(0,0) = 0 & BIT_FLIP(1) = 0 & BIT_FLIP(0) = 1 & WORD_POSITION = BV8_INDEX & !n.(n : WORD => n<=255) & !n.(n : WORD => 0<=n) & NB_WORDS = 256 & 2**8 = 256);
  Seen_Context_List_Properties(Implementation(traffic_light_asm_pic))==(not(COLOR = {}) & !(v1,v2,i).(v1 : BV8 & v2 : BV8 & i : BV8_INDEX => BV8_XOR(v1,v2)(i) = BIT_XOR(v1(i),v2(i))) & BV8_XOR : BV8*BV8 --> BV8 & !(v1,v2,i).(v1 : BV8 & v2 : BV8 & i : BV8_INDEX => BV8_IOR(v1,v2)(i) = BIT_IOR(v1(i),v2(i))) & BV8_IOR : BV8*BV8 --> BV8 & !(v1,v2,i).(v1 : BV8 & v2 : BV8 & i : BV8_INDEX => BV8_AND(v1,v2)(i) = BIT_AND(v1(i),v2(i))) & BV8_AND : BV8*BV8 --> BV8 & !i.(i : BV8_INDEX => BV8_ALL_ZEROES(i) = 0) & BV8_ALL_ZEROES : BV8 & !(v,i).(v : BV8 & i : BV8_INDEX => BV8_COMPLEMENT(v)(i) = BIT_FLIP(v(i))) & BV8_COMPLEMENT : BV8 --> BV8 & !(v,i,b).(v : BV8 & i : BV8_INDEX & b : BIT => BV8_SET_BIT(v,i,b)(i) = b) & !(v,i,j,b).(v : BV8 & i : BV8_INDEX & j : BV8_INDEX & b : BIT => (i/=j => BV8_SET_BIT(v,i,b)(j) = v(j))) & BV8_SET_BIT : BV8*BV8_INDEX*BIT --> BV8 & BV8 = BV8_INDEX --> BIT & BV8_INDEX = 0..7 & !(b1,b2).(b1 : BIT & b2 : BIT => BIT_XOR(b1,b2) = 1 <=> (b1 = 1 & b2 = 0 or (b1 = 0 & b2 = 1))) & BIT_XOR : BIT*BIT --> BIT & !(b1,b2).(b1 : BIT & b2 : BIT => BIT_IOR(b1,b2) = 1 <=> (b1 = 1) or b2 = 1) & BIT_IOR : BIT*BIT --> BIT & !(b1,b2).(b1 : BIT & b2 : BIT => BIT_AND(b1,b2) = 1 <=> (b1 = 1) & b2 = 1) & BIT_AND : BIT*BIT --> BIT & !b.(b : BIT => BIT_FLIP(b) = 1-b) & BIT_FLIP : BIT --> BIT & BIT = 0..1 & REGISTER = 0..127 & REGISTER : POW(INTEGER) & !n.(n : NATURAL & n>0 => 2**n = 2*2**(n-1)) & BV_TO_WORD = WORD_TO_BV~ & !(w,v).(w : WORD & v : BV8 => v = WORD_TO_BV(w) <=> (w = 128*v(7)+64*v(6)+32*v(5)+16*v(4)+8*v(3)+4*v(2)+2*v(1)+v(0))) & WORD_TO_BV : WORD --> BV8 & BV_TO_WORD : BV8 --> WORD & !i.(i : INSTRUCTION => (i = 255 => INSTRUCTION_NEXT(i) = 0) & (i<255 => INSTRUCTION_NEXT(i) = i+1)) & INSTRUCTION_NEXT : INSTRUCTION --> INSTRUCTION & INSTRUCTION = 0..INSTRUCTION_MAX & INSTRUCTION_MAX = NB_INSTRUCTIONS-1 & NB_INSTRUCTIONS = 256 & INST_SZ = 8 & WORD_POSITION = 0..WORD_LENGTH-1 & WORD = 0..NB_WORDS-1 & NB_WORDS = 2**WORD_LENGTH & WORD_LENGTH = 8 & NB_INSTRUCTIONS : NATURAL & NB_WORDS : NATURAL & INST_SZ : NATURAL & WORD_LENGTH : NATURAL);
  Seen_List_Constraints(Implementation(traffic_light_asm_pic))==(btrue);
  Seen_List_Operations(Implementation(traffic_light_asm_pic),Machine(ALU))==(?);
  Seen_Expanded_List_Invariant(Implementation(traffic_light_asm_pic),Machine(ALU))==(btrue);
...
THEORY ListIncludedOperationsX IS
  List_Included_Operations(Implementation(traffic_light_asm_pic),Machine(PIC))==(CALL,RETURN,RETLW,ADDLW,ADDWF,SUBLW,SUBWF,ANDLW,ANDLWF,IORLW,IORLWF,XORLW,XORLWF,BCF,BSF,BTFSC,BTFSS,CLRF,CLRW,COMF,DECF,DECFSZ,INCF,INCFSZ,GOTO,MOVLW,MOVF,MOVWF,NOP,ROLF,RORF,SWAP)
END
&
...
THEORY ListOfIdsX IS
  List_Of_Ids(Implementation(traffic_light_asm_pic)) == (? | ? | ? | ? | advance | ? | seen(Machine(definitions)),seen(Machine(data_refinement)),seen(Machine(TYPES)),seen(Machine(ALU)),imported(Machine(m.PIC)) | ? | traffic_light_asm_pic);
