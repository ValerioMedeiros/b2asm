...
THEORY ListAssertionsX IS
  ...
  List_Assertions(Machine(BYTE_DEFINITION))==(!bt.(bt: BYTE => size(bt) = 8) & size(BYTE_ZERO) = 8 & BYTE <: BIT_VECTOR & BYTE_ZERO: BIT_VECTOR & first(BYTE_ZERO) = 0)
END
&
...
THEORY ListConstantsX IS
  List_Valuable_Constants(Machine(BYTE_DEFINITION))==(BYTE,BYTE_WIDTH,BYTE_INDEX,BYTE_ZERO,REAL_BYTE_INDEX,byte_bit_get);
  Inherited_List_Constants(Machine(BYTE_DEFINITION))==(?);
  List_Constants(Machine(BYTE_DEFINITION))==(BYTE,BYTE_WIDTH,BYTE_INDEX,BYTE_ZERO,REAL_BYTE_INDEX,byte_bit_get)
END
&
THEORY ListSetsX IS
...
THEORY ListPropertiesX IS
  ...
  List_Properties(Machine(BYTE_DEFINITION))==(BYTE_WIDTH = 8 & BYTE_INDEX = 1..BYTE_WIDTH & REAL_BYTE_INDEX = 0..BYTE_WIDTH-1 & BYTE = {bt | bt: BIT_VECTOR & bv_size(bt) = BYTE_WIDTH} & BYTE_ZERO: BYTE & BYTE_ZERO = BYTE_INDEX*{0} & byte_bit_get: BYTE*REAL_BYTE_INDEX --> BIT & byte_bit_get = %(bt,ind).(bt: BYTE & ind: REAL_BYTE_INDEX | bt(ind+1)))
END
&
