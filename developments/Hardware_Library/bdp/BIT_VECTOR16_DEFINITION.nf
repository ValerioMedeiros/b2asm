...
THEORY ListConstantsX IS
  List_Valuable_Constants(Machine(BIT_VECTOR16_DEFINITION))==(BV16_INDX,BV16_WIDTH,BV16_ZERO,BV16,bv16_byte);
  Inherited_List_Constants(Machine(BIT_VECTOR16_DEFINITION))==(?);
  List_Constants(Machine(BIT_VECTOR16_DEFINITION))==(BV16_INDX,BV16_WIDTH,BV16_ZERO,BV16,bv16_byte)
END
&
THEORY ListSetsX IS
