...
THEORY ListAssertionsX IS
  ...
  List_Assertions(Machine(BV16_DEFINITION))==(BV16_ZERO: BV16 & BV16 <: BIT_VECTOR & BV16_ZERO: BIT_VECTOR)
END
&
...
THEORY ListConstantsX IS
  List_Valuable_Constants(Machine(BV16_DEFINITION))==(BV16_INDX,REAL_BV16_INDX,BV16_ZERO,BV16,bv16_byte,byte_bv16,bv16_bit_get);
  Inherited_List_Constants(Machine(BV16_DEFINITION))==(?);
  List_Constants(Machine(BV16_DEFINITION))==(BV16_INDX,REAL_BV16_INDX,BV16_ZERO,BV16,bv16_byte,byte_bv16,bv16_bit_get)
END
&
THEORY ListSetsX IS
