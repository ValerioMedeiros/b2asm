...
THEORY ListIncludedOperationsX IS
  List_Included_Operations(Implementation(traffic_light_asm_z80),Machine(Z80))==(LD_r_r_,LD_r_n_,LD_r_HL,LD_r_9IX_d0,LD_r_9IY_d0,LD_9HL0_n,LD_HL_r,BIT_b_HL,JP_z_e,SET_b_HL,RES_b_HL,GOTO,CALL,RETURN)
END
&
