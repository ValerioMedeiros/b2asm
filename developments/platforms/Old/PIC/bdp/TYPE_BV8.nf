...
THEORY ListConstantsX IS
  List_Valuable_Constants(Machine(TYPE_BV8))==(BV8_INDEX,BV8,BV8_SET_BIT,BV8_COMPLEMENT,BV8_ALL_ZEROES,BV8_AND,BV8_IOR,BV8_XOR);
  Inherited_List_Constants(Machine(TYPE_BV8))==(?);
  List_Constants(Machine(TYPE_BV8))==(BV8_INDEX,BV8,BV8_SET_BIT,BV8_COMPLEMENT,BV8_ALL_ZEROES,BV8_AND,BV8_IOR,BV8_XOR)
END
&
THEORY ListSetsX IS
