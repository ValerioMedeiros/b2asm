...
the functions and to verify its properties. Then, this work specify a model more simple to get better
results fastly, in the same time, stay near to model of actual processors.
...
the confiability and prove process.
 ...
 Others advantages of this work are the aplication of news and advanceds funcionalities of B method.
 These advantages are the paralelization of prove proccess and the instensive use of math patterns associated
 ...
 [AMM]
 Adici \erro [ Adicionar aqui a comparação enviada ao e-mail de David]
