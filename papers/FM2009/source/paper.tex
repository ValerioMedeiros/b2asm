...
As obrigações de provas geradas pela ferramentas garante a verficação dos tipos de dados e que as
expressoes são bem formadas \footnote{An expression is called "well-defined" (or unambiguous) if its definition
assigns it a unique interpretation or value.}. Deste modo, as propriedades citadas anteriomente também são
verificadas. As propriedades citadas anteriormente oferecem garantias que 

[Enfatizar a vantagem]
The traditional don´t allow verify this things and the properties is flexible. The flexbility allow add
restrictions about tempo de execuçao and until specifics restrictions about the application of microcontroller.
...
\begin{tabular}{llll}
\textbf{Group} &  \textbf{Proofs No Obvios} & \textbf{Proofs WD} & × \\ 
Input and Output & 54 & 296  \\ 
Logic and Ari & 134 & 413  \\ 
Manipulation of Bits & 160 & 742  \\ 
Extern actions & 51 & 84  \\
General & 140 & 615  \\
Header & 68 & 169  \\
 & \textbf{Subtotal} 607 & \textbf{Subtotal} 2319  &  \textbf{Total} 2926 \\
\end{tabular}
\end{center}
...
[Conclusao]
A primeira vez que realiza as provas é um pouco trabalhoso, porque as definições de tipos e de hardware não
estavam completas. Então, um trabalho maior foi demandado, por outro lado, foi nece

The first time
Paralelismo vantagem
