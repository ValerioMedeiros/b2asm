...
COMENT SIMONE -> Acho que está muito bom, não tenho o que acrescentar.
...
\begin{table}[h]
\begin{center}
\caption{Packages of the Java Card API (2.2.2)}
\begin{tabular}{|l|c||l|c|}
 \hline
\textbf{Package} & \textbf{classes/} & \textbf{Package} & \textbf{classes/} \\ 
				 & \textbf{package}  &					& \textbf{package} \\ \hline \hline
java.io & 1 & javacardx.biometry & 5 \\ \hline
java.lang & 12 & javacardx.crypto & 2 \\ \hline
java.rmi & 2 & javacardx.external & 3 \\ \hline
javacard.framework & 19 & javacardx.framework.math & 3 \\ \hline
javacard.framework.service & 8 & javacardx.framework.tlv & 7 \\ \hline
javacard.security & 27 & javacardx.framework.util & 2 \\ \hline
javacardx.apdu & 1 & javacardx.framework.util.intx & 1 \\
 \hline
\end{tabular}
\label{tab:packages}
\end{center}
...
COMENT SIMONE -> A tabela está no formato que estava lá na dissertação (muito grande?), tem que ver se tem algum modelo padrão a ser seguido para as tabelas, se tiver é so me passar que eu faço os ajustes. Sobre o link do google code, eu não sei qual o link público lá.
