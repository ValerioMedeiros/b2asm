...
%\documentclass[gray,trans]{beamer} % com o mod transparência
%\documentclass[gray]{beamer}
\documentclass[trans,note]{beamer}
\setbeamertemplate{footline}[frame number] % Mostra o número de frames e não o de slides.
...
%\subtitle{Qualificação de Mestrado} % Enter your title betweencurlybraces
\author{Valério Medeiros Jr, David Déharbe}
...
\beamertemplatefootpagenumber % Mostra o número de páginas
...
% Mostra um slide com destaque a atual seção, em cada mudança de seção
%  \AtBeginSection[]
%  {
%  \begin{frame}
%  \frametitle{Summary}
