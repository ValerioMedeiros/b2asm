...
%-> Quanto tempo foi gasto nessa verificação ? a minha dissertação diz que aproximadamente dois meses. Utilizando as regras este tempo caiu p/ 5 dias (linkar com este parágrafo)

%-> Aproximadamente quanto tempo de processamento elas reduziram ?
% Porque o modelo não foi verificado completamente ? Isto é viavel ?
 %There are many benefits when a formal model is
...
% Resumo de como aconteceu o processo de verificação, (melhor está após as estátisticas) ( )Atualizar dados
