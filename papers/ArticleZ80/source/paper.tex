...
the execution time of a routine.  Two aspects of such formalization
...
some informations are organized in different sections of document and
...
described informally, and is this description is scattered in
...
formally the assembly instruction set, making it possible to prove
...
of rules included in the free distribution of AtelierB. So we
